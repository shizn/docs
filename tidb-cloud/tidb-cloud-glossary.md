...
Chat2Query is an AI-powered feature integrated into SQL Editor that assists users in generating, debugging, or rewriting SQL queries based on natural language instructions. For more information, see [Chat2Query (beta)](/tidb-cloud/explore-data-with-chat2query.md).
